/**
 * Code challenge week 43, 2021 (language: GO, playground: https://play.golang.org/)
 *
 * Description:
 *     The code below is supposed to print the battery percentage status for a couple of vehicles. But once ran there is an error.
 *
 * Questions:
 *     1. Why is there an error?
 *     2. How can the code be adjusted so that the battery percentage status is printed?
 */
